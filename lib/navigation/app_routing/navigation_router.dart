...
import 'package:gu_mobile/ui/check_email_page/view/check_email.dart';
...
import 'package:gu_mobile/ui/user_profile_page/view/user_profile.dart';
...
final _router = GoRouter(initialLocation: AppRoutes.home.path(), routes: [
  ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
            path: AppRoutes.checkEmail.path(),
            name: AppRoutes.checkEmail.name,
            builder: (context, state) {
