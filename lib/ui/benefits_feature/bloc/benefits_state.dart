...
sealed class BenefitsState extends Equatable {
  const BenefitsState(this.benefits, this.filteredBenefits, this.categories,
...
final class BenefitsInitial extends BenefitsState {
  const BenefitsInitial(super.benefits, super.filteredBenefits,
      super.categories, super.selectedCategories);
}

final class BenefitsSuccessState extends BenefitsState {
  const BenefitsSuccessState(super.benefits, super.filteredBenefits,
      super.categories, super.selectedCategories);
...
final class BenefitsFailState extends BenefitsState {
  const BenefitsFailState(super.benefits, super.filteredBenefits,
      super.categories, super.selectedCategories);
}

final class BenefitsLoadingState extends BenefitsState {
  const BenefitsLoadingState(super.benefits, super.filteredBenefits,
      super.categories, super.selectedCategories);
}
